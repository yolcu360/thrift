...
function unicodeEscape(str) {
  return str.replace(/[^ \000-\177]/g, function (escape) {
...
Thrift.Protocol.prototype = {
    ...
    writeMessageEnd: function() {
        ...
        // For pure object serializetion
        if (typeof this.wobj === "undefined") {
            this.wbuf = obj;
        } else {
            this.wobj.push(obj);
    ...
    writeStructBegin: function(name) {
        // Support pure object serializatoin
        if(typeof this.tstack === "undefined") {
            this.tstack = [];
            this.tpos = [];
        }
    ...
    writeString: function(str) {
        ...
        if (str === null) {
            ...
            escapedString = unicodeEscape(escapedString)
    ...
    readStructBegin: function(name) {
        // Support pure object serialization
        if(typeof this.rstack === "undefined") {
            this.rstack = [JSON.parse(this.transport.readAll())]
            this.rpos = [];
        }
        var r = {};
        r.fname = '';
